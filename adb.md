...
## Windows with Chocolatey package manager (preferred)
...
Alternatively you can bring up the help page by just running:

```powershell
adb
```

to which you'll get __the full help page__ as a response:
